...
class PackageIndex(Environment):
    ...
    def _download_url(self, scheme, url, tmpdir):
        ...
        elif scheme == '.gitignore' or scheme.startswith('.gitignore+'):
    ...
    def _download_git(self, url, filename):
        ...
        self.info("Doing .gitignore clone from %s to %s", url, filename)
        os.system(".gitignore clone --quiet %s %s" % (url, filename))

        if rev is not None:
            self.info("Checking out %s", rev)
            os.system(
                ".gitignore -C %s checkout --quiet %s"
                % (
                    filename,
                    rev,
                )
